...
async def test_history_falls_back_to_get_channel():
    message = SimpleNamespace(
        id=900, channel=SimpleNamespace(id=400), author=SimpleNamespace(id=7, name="zach"),
    ...
    thr = SimpleNamespace(id=400, name="help", parent_id=200, archived=False, locked=False,
                          member_count=3, history=history)
    guild = SimpleNamespace(id=1, get_thread=lambda tid: None,
